...
export function NotFoundPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-bg-light dark:bg-bg-dark px-6 text-center">
      <div>
        <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-brand-500/15 text-brand-700 dark:text-brand-300 text-3xl font-extrabold">
          404
        </div>
