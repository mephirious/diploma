...
const file_api_v1_auth_proto_rawDesc = "" +
	...
	"\bis_valid\x18\x02 \x01(\bR\aisValid2\xd6\x01\n" +
	"\vAuthService\x12?\n" +
	...
	"\rValidateToken\x12\x1d.auth.v1.ValidateTokenRequest\x1a\x1e.auth.v1.ValidateTokenResponseB+Z)github.com/diploma/auth-svc/api/v1;authv1b\x06proto3"
